...
export const SocketProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    socketInstance.on('connect', () => {
      ...
      // Register user with available data - include more specific team info
      socketInstance.emit('register', {
        userId: socketInstance.id,
        role: user.role,
        team: user.team || null,
        // Add a specific team type identifier if available
    ...
    socketInstance.on('order-updated', (data) => {
      ...
      // Here's where you would handle the order update in your app
      // You should dispatch to your state management or call a handler function
...
//       // Register user with available data
//       socketInstance.emit('register', {
//         userId: socketInstance.id,
//         role: user.role,
//         team: user.team || null,
...
//   // Function to notify order updates through socket
//   const notifyOrderUpdate = useCallback((updatedOrder) => {
//     if (socket && isConnected) {
//       const teamType = user.teamType || user.team || 'unknown';
//       console.log(`📤 Sending order update via socket from ${teamType} team:`, updatedOrder);
